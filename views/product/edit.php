...
<body>
  <div class="bg-white border border-2 rounded-lg shadow relative m-10 max-w-4xl m-auto mt-4">
    ...
    <form method="POST" enctype="multipart/form-data" action="index.php?route=product/edit&id=<?= $product['id']?>">
      <div class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-4 gap-6">
          <div class="col-span-4">
            ...
            <input type="text" name="name" id="name" value="<?= $product['name']?>" class=" shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg
              focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Apple Imac 27”">
          </div>
          <div class="col-span-4">
            ...
            <select name="category_id" id="category_id" required
              ...
              <option <?php if($category['id'] === $product['categoryId']){echo 'selected';}?>
          ...
          <div class="col-span-4">
            ...
            <input type="file" name="image" id="image" value="<?= $product['image_name']?>"
          ...
          <div class="col-span-full">
            ...
            <textarea id="description" rows="6" name="description"
              ...
              placeholder="Details"><?= $product['description']?></textarea>
          </div>
        </div>
      </div>
